...
// restClient is a small shared JSON-over-HTTP helper, mirroring
// bot-service's internal/repository/httpclient.go so both services talk to
// their REST dependencies the same way.
